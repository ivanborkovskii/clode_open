...
echo "  готово: $out"
echo
echo "  НЕ ЗАБУДЬТЕ ДВЕ ВЕЩИ:"
echo
echo "  1. В архив для хостинга кладутся файлы ОТСЮДА, из build/assets,"
echo "     а не из public/assets. В public лежат исходники с комментариями."
echo "     Положить их на сервер — значит затереть сжатые копии, и аудит"
echo "     справедливо скажет, что стили и скрипты не минифицированы."
echo
echo "  2. Поднять assets_version в config/app.php, иначе браузеры"
echo "     возьмут прежние файлы из своей памяти."
